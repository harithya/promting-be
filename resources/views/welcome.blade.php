...
<body class="antialiased text-slate-900 bg-white">
    ...
    <section id="home" class="pt-32 pb-16 sm:pt-48 sm:pb-32 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
            ...
            <div class="max-w-3xl mx-auto">
                <span
                    class="inline-block py-1 px-4 rounded-full bg-primary-light text-primary text-xs font-bold tracking-wider uppercase mb-6">#1
                    AI Prompt Builder for Creators</span>
                ...
                <p class="text-lg sm:text-xl text-slate-600 leading-relaxed mb-10 px-4">
                    Cukup isi form dan pilih template. Sistem kami secara otomatis merangkai prompt yang optimal untuk
                    Midjourney, Stable Diffusion, dan DALL-E.
                </p>
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <a href="#cta"
                        class="w-full sm:w-auto bg-primary text-white px-8 py-4 rounded-full text-lg font-bold hover:bg-primary-dark transition-all shadow-xl shadow-primary/30 active:scale-95">Generate
                        Prompt Sekarang</a>
                    <a href="#templates"
            ...
            <div class="mt-20 relative mx-auto max-w-5xl group">
                <div
                    class="absolute inset-0 bg-primary/20 blur-[100px] -z-10 opacity-50 group-hover:opacity-70 transition-opacity">
                </div>
                <div
                    class="bg-white rounded-2xl p-2 shadow-2xl border border-slate-100 overflow-hidden transform group-hover:-translate-y-2 transition-transform duration-500">
                    <img src="{{ asset('images/dashboard-mockup.png') }}" alt="RIA Prompt Dashboard"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="text-center mb-20">
                <span class="text-red-500 font-bold tracking-widest uppercase text-xs mb-4 block">The Brutal
                    Truth</span>
                <h2 class="text-4xl sm:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight">Kualitas Gambar AI
                    Anda <br> Bergantung pada <span class="text-primary italic">Satu Hal Penting</span></h2>
                <p class="text-slate-600 max-w-2xl mx-auto text-lg leading-relaxed">Banyak orang gagal bukan karena
                    AI-nya buruk, tapi karena mereka tidak tahu cara berkomunikasi dengan AI tersebut. Apakah Anda
                    sering mengalami ini?</p>
            </div>
                ...
                <div
                    ...
                    <div class="relative z-10">
                        ...
                        <h3 class="text-2xl font-bold mb-4 text-slate-900 leading-tight">Prompt Biasa Saja? <br> Hasil
                            Biasa Saja.</h3>
                        <p class="text-slate-500 text-sm leading-relaxed">Menggunakan prompt pendek tanpa detail hanya
                            akan menghasilkan gambar yang membosankan dan tidak berjiwa.</p>
                    </div>
                </div>
                <!-- Pain Point 2 -->
                <div
                    ...
                    <div class="relative z-10">
                        ...
                        <h3 class="text-2xl font-bold mb-4 text-slate-900 leading-tight">Membuang Credit <br> Secara
                            Percuma.</h3>
                        <p class="text-slate-500 text-sm leading-relaxed">Berapa banyak credit Midjourney yang Anda
                            habiskan hanya untuk "menebak-nebak" kata kunci yang tepat?</p>
                    </div>
                </div>
                <!-- Pain Point 3 -->
                <div
                    ...
                    <div class="relative z-10">
                        ...
                        <h3 class="text-2xl font-bold mb-4 text-slate-900 leading-tight">Frustrasi <br> Tanpa Henti.
                        </h3>
                        <p class="text-slate-500 text-sm leading-relaxed">Menghabiskan waktu berjam-jam di depan layar
                            hanya untuk hasil yang "lumayan", bukan yang luar biasa.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="relative">
                    ...
                    <div class="bg-white p-6 rounded-[2rem] shadow-xl border border-slate-100">
                        <div class="space-y-4">
                            <div
                                class="flex items-start gap-4 p-4 rounded-2xl bg-primary-light/50 border border-primary/10">
                                <div
                                    class="w-10 h-10 bg-primary rounded-xl flex items-center justify-center shrink-0 text-white shadow-lg text-xl">
                                    📝
                                </div>
                                <div>
                                    <h4 class="font-bold text-slate-900">Form-Based Builder</h4>
                                    <p class="text-sm text-slate-600">Cukup jawab pertanyaan simpel seperti "Style apa
                                        yang kamu mau?"</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-4 p-4 rounded-2xl bg-blue-50 border border-blue-100">
                                <div
                                    class="w-10 h-10 bg-blue-500 rounded-xl flex items-center justify-center shrink-0 text-white shadow-lg text-xl">
                                    📚
                                </div>
                                <div>
                                    <h4 class="font-bold text-slate-900">Ratusan Template</h4>
                                    <p class="text-sm text-slate-600">Mulai dari Portrait hingga Concept Art, semua
                                        sudah ada polanya.</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-4 p-4 rounded-2xl bg-amber-50 border border-amber-100">
                                <div
                                    class="w-10 h-10 bg-amber-500 rounded-xl flex items-center justify-center shrink-0 text-white shadow-lg text-xl">
                                    ⚡
                                </div>
                                <div>
                                    <h4 class="font-bold text-slate-900">Prompt Terstruktur</h4>
                                    <p class="text-sm text-slate-600">Hasil prompt otomatis menyertakan parameter
                                        teknis untuk hasil terbaik.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <h2 class="text-3xl sm:text-4xl font-extrabold text-slate-900 leading-tight mb-6">Satu Solusi Untuk
                        Semua Kebutuhan Prompt Anda</h2>
                    <p class="text-lg text-slate-600 mb-8">RIA Prompt dirancang agar SIAPAPUN bisa menjadi AI Prompt
                        Engineer profesional hanya dalam hitungan detik.</p>
                    <ul class="space-y-4 mb-10">
                        <li class="flex items-center gap-3 font-semibold text-slate-700">
                            <div
                                class="w-6 h-6 bg-primary/20 text-primary rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <a href="#cta"
                        class="inline-flex items-center gap-2 bg-primary text-white px-8 py-4 rounded-full text-lg font-bold hover:bg-primary-dark transition-all shadow-xl shadow-primary/30 group">
    ...
    <section class="py-24 bg-slate-900 text-white overflow-hidden relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-20">
                <h2 class="text-4xl sm:text-5xl font-extrabold mb-6 tracking-tight">Hanya 3 Langkah Untuk Gambar
                    Sempurna</h2>
                <p class="text-slate-400 max-w-2xl mx-auto text-lg leading-relaxed">System kami bekerja di balik layar
                    untuk memastikan setiap kata kunci optimal.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                ...
                <div
                    ...
                    <div
                        ...
                        1</div>
                    <h3 class="text-2xl font-bold mb-4">Isi Form</h3>
                    <p class="text-slate-400 leading-relaxed text-sm">Jawab pertanyaan simpel tentang mood, lighting,
                        dan subject yang kamu inginkan.</p>
                    <div
                ...
                <div
                    ...
                    <div
                        class="w-16 h-16 bg-primary text-white rounded-2xl flex items-center justify-center mx-auto mb-8 text-2xl font-black shadow-xl shadow-primary/20 -rotate-3 group-hover:rotate-0 transition-transform">
                        2</div>
                    <h3 class="text-2xl font-bold mb-4">Copy JSON</h3>
                    <p class="text-slate-400 leading-relaxed text-sm">Salin struktur prompt profesional dalam format
                        JSON yang siap diproses oleh engine AI.</p>
                    <div
                        class="hidden md:block absolute top-1/2 -right-4 translate-x-1/2 -translate-y-1/2 text-primary/30 z-20">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3"
                ...
                <div
                    ...
                    <div
                        ...
                        3</div>
                    <h3 class="text-2xl font-bold mb-4">Generate & Nikmati</h3>
                    <p class="text-slate-400 leading-relaxed text-sm">Tempel di AI image generator favoritmu dan lihat
                        imajinasimu menjadi nyata!</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-slate-50 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-slate-900 rounded-[3rem] p-8 sm:p-16 relative overflow-hidden shadow-2xl">
                <div class="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-primary/10 to-transparent">
                </div>

                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                    <div>
                        <h2 class="text-3xl sm:text-4xl font-extrabold text-white mb-6">Contoh Nyata Magic RIA Prompt
                        </h2>
                        <p class="text-slate-400 text-lg mb-8 leading-relaxed">Lihat bagaimana input yang sangat simpel
                            diubah menjadi prompt yang detail, teknis, dan siap pakai.</p>

                        <div class="space-y-6">
                            <div class="bg-white/5 border border-white/10 rounded-2xl p-6">
                                <p class="text-xs font-bold text-primary tracking-widest uppercase mb-3 text-white/50">
                                    User Input Form:</p>
                                <p class="text-white font-medium italic">"Seorang kesatria cyberpunk di tengah hujan
                                    kota futuristik, style cinematic, lighting neon"</p>
                            </div>
                            <div class="flex justify-center">
                                <svg class="w-8 h-8 text-primary animate-bounce-horizontal" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="bg-primary/20 border border-primary/30 rounded-2xl p-6 relative group">
                                <div
                                    class="absolute top-3 right-3 text-primary/50 group-hover:text-primary cursor-pointer transition-colors">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                    </svg>
                                </div>
                                <p class="text-xs font-bold text-primary tracking-widest uppercase mb-3">Generated RIA
                                    Prompt:</p>
                                <p class="text-white font-mono text-sm leading-relaxed">
                                    A hyper-realistic cinematic portrait of a cybernetic knight standing in the heavy
                                    rain of a futuristic 2077 Tokyo city, dramatic neon pink and cyan rim lighting,
                                    volumetric fog, sharp focus, 8k resolution, Unreal Engine 5 render, highly detailed
                                    armor texture, rainy environment --ar 16:9 --v 6.0
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative hidden lg:block">
                        <div
                            class="bg-white items-center gap-1 justify-center rounded-3xl overflow-hidden shadow-2xl rotate-3 group-hover:rotate-0 transition-all duration-500">
                            <div class="p-2">
                                <div class="bg-slate-200 aspect-[4/5] rounded-2xl flex items-center justify-center text-slate-400 font-bold overflow-hidden bg-cover bg-center"
                                    style="background-image: url('https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1074&q=80')">
                                    <!-- This is just a visual placeholder for the result image -->
                                </div>
                            </div>
                            <div
                                class="p-4 bg-white flex justify-between items-center text-xs font-bold text-slate-400 uppercase tracking-widest">
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl sm:text-4xl font-extrabold text-slate-900 mb-4">Mengapa Harus Menggunakan RIA
                    Prompt?</h2>
                <p class="text-slate-600 max-w-2xl mx-auto">Dirancang untuk memaksimalkan kreativitas tanpa hambatan
                    teknis yang membosankan.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="space-y-4">
                    <div
                        class="w-12 h-12 bg-primary-light text-primary rounded-2xl flex items-center justify-center shadow-lg shadow-primary/5">
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Pangkas waktu berjam-jam trial-error di
                        Discord/Web generator menjadi hanya hitungan detik.</p>
                </div>
                <div class="space-y-4">
                    <div
                        class="w-12 h-12 bg-primary-light text-primary rounded-2xl flex items-center justify-center shadow-lg shadow-primary/5">
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Prompt yang dihasilkan mengikuti format best
                        practice terbaru untuk masing-masing engine AI.</p>
                </div>
                <div class="space-y-4">
                    <div
                        class="w-12 h-12 bg-primary-light text-primary rounded-2xl flex items-center justify-center shadow-lg shadow-primary/5">
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Pahami struktur prompt yang baik hanya dengan
                        mengamati hasil generate dari tool ini.</p>
                </div>
                <div class="space-y-4">
                    <div
                        class="w-12 h-12 bg-primary-light text-primary rounded-2xl flex items-center justify-center shadow-lg shadow-primary/5">
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed">Tim kami selalu menambahkan template dan kategori
                        baru setiap minggunya.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="faq" class="py-24 bg-slate-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl sm:text-4xl font-extrabold text-slate-900 leading-tight mb-4">Paling Sering
                    Ditanyakan</h2>
            </div>
            ...
            <div class="space-y-4">
                <div class="bg-white rounded-2xl shadow-sm overflow-hidden border border-slate-100">
                    <button class="w-full px-6 py-5 text-left flex justify-between items-center group">
                        <span class="font-bold text-slate-900 group-hover:text-primary transition-colors">Apakah RIA
                            Prompt gratis?</span>
                        <svg class="w-5 h-5 text-slate-400 group-hover:text-primary transition-transform"
                    ...
                    <div class="px-6 pb-5 text-slate-600 text-sm leading-relaxed">
                        Anda dapat mencoba RIA Prompt secara gratis. Kami juga menyediakan paket premium bagi user yang
                        membutuhkan akses ke template eksklusif dan jumlah generate tanpa batas.
                    </div>
                </div>
                <div class="bg-white rounded-2xl shadow-sm overflow-hidden border border-slate-100">
                    <button class="w-full px-6 py-5 text-left flex justify-between items-center group">
                        <span class="font-bold text-slate-900 group-hover:text-primary transition-colors">Apakah ini
                            bekerja untuk Midjourney?</span>
                        <svg class="w-5 h-5 text-slate-400 group-hover:text-primary transition-transform"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 9l-7 7-7-7" />
                    ...
                    <div class="px-6 pb-5 text-slate-600 text-sm leading-relaxed">
                        Sangat bisa! Prompt yang kami hasilkan bahkan sudah dilengkapi parameter khusus seperti --ar
                        (aspect ratio), --v (version), dan negative prompt untuk hasil terbaik.
                    </div>
                </div>
                <div class="bg-white rounded-2xl shadow-sm overflow-hidden border border-slate-100">
                    <button class="w-full px-6 py-5 text-left flex justify-between items-center group">
                        <span class="font-bold text-slate-900 group-hover:text-primary transition-colors">Saya pemula,
                            apakah susah menggunakannya?</span>
                        <svg class="w-5 h-5 text-slate-400 group-hover:text-primary transition-transform"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 9l-7 7-7-7" />
                    ...
                    <div class="px-6 pb-5 text-slate-600 text-sm leading-relaxed">
                        Sama sekali tidak. Anda tidak perlu menghafal keyword teknis. Cukup jawab pertanyaan simpel di
                        form, dan system kami yang akan bekerja merangkai katanya untuk Anda.
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-primary-light/50 border border-primary/10 rounded-[3rem] p-8 sm:p-16 text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    <div
                        class="bg-white p-10 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 text-left">
                        ...
                        <ul class="space-y-4 mb-10">
                            <li class="flex items-center gap-3 text-sm font-semibold text-slate-700">✅ 5 Generate per
                                hari</li>
                            <li class="flex items-center gap-3 text-sm font-semibold text-slate-700">✅ 10 Template
                                Dasar</li>
                            <li class="flex items-center gap-3 text-sm font-semibold text-slate-700">✅ Akses Komunitas
                            </li>
                        </ul>
                        <a href="/register"
                            class="block w-full text-center py-4 bg-slate-100 text-slate-700 font-bold rounded-2xl hover:bg-slate-200 transition-colors">Daftar
                            Sekarang</a>
                    </div>
                    <div
                        class="bg-slate-900 p-10 rounded-[2rem] shadow-2xl shadow-primary/20 text-left relative overflow-hidden group">
                        <div
                            class="absolute top-0 right-0 w-24 h-24 bg-primary rounded-bl-full flex items-center justify-center pl-4 pt-1">
                            <svg class="w-8 h-8 text-white group-hover:scale-110 transition-transform"
                        ...
                        <ul class="space-y-4 mb-10">
                            <li class="flex items-center gap-3 text-sm font-semibold text-slate-300">✅ Unlimited
                                Generate</li>
                            <li class="flex items-center gap-3 text-sm font-semibold text-slate-300">✅ 50+ Exclusive
                                Template</li>
                            <li class="flex items-center gap-3 text-sm font-semibold text-slate-300">✅ Prioritas Fitur
                                Baru</li>
                        </ul>
                        <a href="/checkout"
                            class="block w-full text-center py-4 bg-primary text-white font-bold rounded-2xl hover:bg-primary-dark transition-all transform active:scale-95">Upgrade
                            Ke Premium</a>
                    </div>
                </div>
            </div>
    ...
    <section id="cta" class="py-32 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-4xl sm:text-6xl font-extrabold text-slate-900 mb-8 leading-[1.2]">Jangan Biarkan
                Imajinasimu <span class="text-primary italic">Terbatas</span> Hanya Karena Prompt</h2>
            <p class="text-xl text-slate-600 mb-12 max-w-2xl mx-auto leading-relaxed">Gabung dengan ribuan creator
                lainnya yang sudah meningkatkan kualitas karyanya bersama RIA Prompt.</p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                <div class="col-span-1 md:col-span-1">
                    ...
                    <p class="text-sm leading-relaxed mb-6">#1 Form-based AI Prompt Builder. Kami mempermudah interaksi
                        manusia dengan kecerdasan buatan melalui tool yang intuitif dan profesional.</p>
                </div>
